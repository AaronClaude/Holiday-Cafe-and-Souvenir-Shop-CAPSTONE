                ...
                <nav>
                  ...
                  <label for="click" class="menu-mobile-btn">
                    ...
                    <ul>
                        ...
                        <a class="sign-up" href="PHP/userlogin.php"><i class="bi bi-person-circle"></i> Account</a>
...
<main>
  <section id="home">
    <div class="container" data-aos="fade-right"> 
      ...
      <a href="PHP/user-condition.php" class="btn-3" id="shop-now">Shop Now!</a>
    </div>
  </section>
</main>
 ...
 <!-- Starting Our Services Section -->
        ...
        <div class="col-md-6 col-lg-3">
          <div class="card" data-aos="flip-right">
            ...
            <div class="card-body">
              ...
              <a href="PHP/user-condition.php" class="btn-1">Learn More</a>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
  ...
  <section id="featured-products">
    <div class="container">
      ...
      <a href="PHP/user-condition.php" class="btn-1"><i class="bi bi-bag-heart"></i> CHECK OUT NOW!</a>
    </div>
  </section>
  ...
  <section id="products">
    <div class="container" data-aos="fade-up">
      <h2>Our Menu</h2>
      <p>Experience the essence of indulgence with our expertly blended coffees, premium teas, delectable pastries, and much more! <a href="PHP/user-condition.php">View All</a></p>
    </div>
    ...
    <div class="col-md-3">
      <div class="card" id="product-card" data-aos="flip-right">
        ...
        <div class="card-body">
          ...
          <br>
          <a href="PHP/user-condition.php" class="btn-1">Order Now</a>
        </div>
      </div>
    </div>
  ...
  <div class="row justify-content-center">
    ...
    <a href="PHP/user-condition.php" class="btn-2" id="view-more"><i class="bi bi-search-heart-fill"></i> VIEW MORE</a>
</div>
 ...
 <!-- End of Our Product Section -->
  ...
  <section id="discount-products">
    <div class="container">
      ...
      <a href="#contacts" class="btn-4"><i class="bi bi-telephone-fill"></i> CONTACT US!</a>
    </div>
  </section>
